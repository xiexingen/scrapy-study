...
class CDESPider(scrapy.Spider):
    name = 'cde'
    pageSize = 1
    allowed_domains = ["mpqqweixin.com"]
    # start_urls = [
    #     'http://yscro.mpqqweixin.com/m/gcplist.aspx?provinceid=0&cityid=0&regionid=0&gcpid=0&areaname=%E5%85%A8%E5%9B%BD&majorid=&majorname_2=&name=',
    # ]
